...
public class MovieAndVoteControllerTestIt {
...
//		movieJsonObject.put("votes", "0");
//		final ObjectMapper objectMapper = new ObjectMapper();
//		
//		HttpEntity<String> request = 
//			      new HttpEntity<String>(movieJsonObject.toString(), httpHeaders);
//		
//		String movieResultAsJsonStr = restTemplate.postForObject(
//				restMoviesPost_MovieControllerUrl_addAMovie, request, String.class);
//
...
//	}
	...
	public void isCorrectJsonReturnedAfterVotingForAMovie_restMoviesVoteGet_MovieController()
		...
		String response = this.restGetTemplate.getForObject("/rest/movies/vote/1",
				String.class);
		
		JSONAssert.assertEquals("{title:\"The Matrix\",votes:3},", response,
				false);
	}
...
//	}
	...
	public void isCorrectJsonReturnedAfterJustAddingARandomVote_restMoviesActionVoteGet_VoteController()
		...
		String response = this.restGetTemplate.getForObject("/rest/movies/action/vote/88",
				String.class);
		
		JSONAssert.assertEquals("{movieid:88}", response, false);
	}
